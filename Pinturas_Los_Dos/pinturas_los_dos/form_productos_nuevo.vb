...
Public Class form_productos_nuevo
    ...
    Function get_precio_compra() As Double
        ...
        precio = Math.Round(Convert.ToDouble(precio), 2)
        Return precio
    End Function
    ...
    Private Sub combo_med2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles combo_med2.KeyPress
        If (Asc(e.KeyChar)) = 13 Then
            ...
            lblcompra.Text = "Q.  " & Convert.ToDouble(precio_compra)
        End If
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If verificar() Then
            ...
            For Each c As Medidas In lista_medidas
                con.insertar("INSERT into presentacion values (" & Double.Parse(c.get_p_venta) & "," & Double.Parse(c.get_p_compra) & "," & id & "," & Integer.Parse(c.get_id) & ")", "Medida con exito", False, 0)
            Next
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If Not TextBox7.Text.Trim() = "" Then
            buscar()
        Else
